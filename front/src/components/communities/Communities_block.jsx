...
function Communities_block() {

    // style={'box-shadow: 0px 1px 12px black; border-radius: 9999px'}
  return (
    <>
    <div id='' className='h-[130px] grid grid-cols-insideCommunities border-b-2 border-boring-blue border-solid '>
        ...
        <div id='' className='flex flex-col justify-center ml-[10%]'>
            <div id='' className=''>
                <h1 className='text-[black] text-[22px] font-[Poppins] font-[400]'>Athlone</h1>
            </div>
            <div id='' className=''>
                <h2 className='text-gray-700     text-[15px] font-[Poppins] font-[400]'><span>8 000</span> | people in the area </h2>
            </div>
        </div>
